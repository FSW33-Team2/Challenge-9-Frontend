...
// import gambar
import scrollDownImage from "../images/scroll-down.svg";
import switchLeft from "../images/switch-left.svg";
import switchRight from "../images/switch-right.svg";
import ellipse from "../images/ellipse.svg";
import ellipseOutline from "../images/ellipse-outline.svg";
import evanlahti from "../images/evan-lahti.jpg";
import tweeterSvg from "../images/twitter.svg";
import jadaGriffin from "../images/jada-griffin.jpg";
import aaronwiliam from "../images/aaron-williams.jpg";
    ...
    <React.Fragment>
      ...
      <section className="page1">
        <nav className="navbar navbar-light">
          ...
          <div className="navteks6">
            <a className="click1" href="/register">
              SIGN UP
            </a>
          </div>
          <div className="navteks7">
            <a className="click1" href="/login">
              LOGIN
            </a>
          </div>
        </nav>
      ...
      <section className="page6">
        ...
        <div className="teks7-page6">
          ...
          <div>QUOTES</div>
          <img className="logo" src={facebookSvg} alt="facebook" />
          <img className="logo" src={tweeterSvg} alt="twitter" />
          <img className="logo" src={vector} alt="yotube" />
          <img className="logo" src={twitch} alt="twitch" />
        </div>
